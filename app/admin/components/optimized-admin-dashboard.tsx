...
const PostEditor = lazy(() => import("./post-editor").then(module => ({ default: module.PostEditor })))
...
// Optimized loading fallback for lazy components
...
export const OptimizedAdminDashboard = memo(() => {
  ...
  const handlePostEdit = useMemo(() => (postId: string) => {
